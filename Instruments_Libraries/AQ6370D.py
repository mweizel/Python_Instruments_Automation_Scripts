...
class AQ6370D(BaseInstrument):
    ...
    @deprecated("Use 'get_display_auto_y' instead")
    def ask_DisplayAutoY(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_display_auto_y()"""
        self.logger.warning(
            "Method 'ask_DisplayAutoY()' is deprecated. Please use 'get_display_auto_y()' instead."
        )
        return self.get_display_auto_y(*args, **kwargs)

    @deprecated("Use 'get_display_y_unit' instead")
    def ask_DisplayYUnit(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_display_y_unit()"""
        self.logger.warning(
            "Method 'ask_DisplayYUnit()' is deprecated. Please use 'get_display_y_unit()' instead."
        )
        return self.get_display_y_unit(*args, **kwargs)

    @deprecated("Use 'get_wavelength_start' instead")
    def ask_WavelengthStart(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_wavelength_start()"""
        self.logger.warning(
            """Method 'ask_WavelengthStart()' is deprecated. 
            Please use 'get_wavelength_start()' instead."""
        )
        return self.get_wavelength_start(*args, **kwargs)

    @deprecated("Use 'get_wavelength_stop' instead")
    def ask_WavelengthStop(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_wavelength_stop()"""
        self.logger.warning(
            """Method 'ask_WavelengthStop()' is deprecated. 
            Please use 'get_wavelength_stop()' instead."""
        )
        return self.get_wavelength_stop(*args, **kwargs)

    @deprecated("Use 'get_center_wavelenght' instead")
    def ask_CenterWavelenght(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_center_wavelenght()"""
        self.logger.warning(
            """Method 'ask_CenterWavelenght()' is deprecated. 
            Please use 'get_center_wavelenght()' instead."""
        )
        return self.get_center_wavelenght(*args, **kwargs)

    @deprecated("Use 'get_data_format' instead")
    def ask_DataFormat(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_data_format()"""
        self.logger.warning(
            """Method 'ask_DataFormat()' is deprecated. 
            Please use 'get_data_format()' instead."""
        )
        return self.get_data_format(*args, **kwargs)

    @deprecated("Use 'get_unit_x' instead")
    def ask_UnitX(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_unit_x()"""
        self.logger.warning(
            """Method 'ask_UnitX()' is deprecated. 
            Please use 'get_unit_x()' instead."""
        )
        return self.get_unit_x(*args, **kwargs)

    @deprecated("Use 'get_trace_state' instead")
    def ask_TraceState(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_trace_state()"""
        self.logger.warning(
            """Method 'ask_TraceState()' is deprecated. 
            Please use 'get_trace_state()' instead."""
        )
        return self.get_trace_state(*args, **kwargs)

    @deprecated("Use 'get_trace_active' instead")
    def ask_TraceActive(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_trace_active()"""
        self.logger.warning(
            """Method 'ask_TraceActive()' is deprecated. 
            Please use 'get_trace_active()' instead."""
        )
        return self.get_trace_active(*args, **kwargs)

    @deprecated("Use 'get_central_wavelenght' instead")
    def ask_CentralWavelenght(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_central_wavelenght()"""
        self.logger.warning(
            """Method 'ask_CentralWavelenght()' is deprecated. 
            Please use 'get_central_wavelenght()' instead."""
        )
        return self.get_central_wavelenght(*args, **kwargs)

    @deprecated("Use 'get_span' instead")
    def ask_Span(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_span()"""
        self.logger.warning(
            """Method 'ask_Span()' is deprecated. 
            Please use 'get_span()' instead."""
        )
        return self.get_span(*args, **kwargs)

    @deprecated("Use 'get_trace_resolution' instead")
    def ask_TraceResolution(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_trace_resolution()"""
        self.logger.warning(
            """Method 'ask_TraceResolution()' is deprecated. 
            Please use 'get_trace_resolution()' instead."""
        )
        return self.get_trace_resolution(*args, **kwargs)

    @deprecated("Use 'get_bw_resolution' instead")
    def ask_BWResolution(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_bw_resolution()"""
        self.logger.warning(
            """Method 'ask_BWResolution()' is deprecated. 
            Please use 'get_bw_resolution()' instead."""
        )
        return self.get_bw_resolution(*args, **kwargs)

    @deprecated("Use 'get_sensitivity' instead")
    def ask_Sensitivity(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_sensitivity()"""
        self.logger.warning(
            """Method 'ask_Sensitivity()' is deprecated. 
            Please use 'get_sensitivity()' instead."""
        )
        return self.get_sensitivity(*args, **kwargs)
    ...
    def ask_AverageCount(self, *args, **kwargs):  # noqa: N802
        ...
        self.logger.warning(
            """Method 'ask_AverageCount()' is deprecated. 
            Please use 'get_average_count()' instead."""
        )
        return self.get_average_count(*args, **kwargs)

    @deprecated("Use 'get_segment_points' instead")
    def ask_SegmentPoints(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_segment_points()"""
        self.logger.warning(
            """Method 'ask_SegmentPoints()' is deprecated. 
            Please use 'get_segment_points()' instead."""
        )
        return self.get_segment_points(*args, **kwargs)

    @deprecated("Use 'get_sample_points' instead")
    def ask_SamplePoints(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_sample_points()"""
        self.logger.warning(
            """Method 'ask_SamplePoints()' is deprecated. 
            Please use 'get_sample_points()' instead."""
        )
        return self.get_sample_points(*args, **kwargs)

    @deprecated("Use 'get_sample_points_auto' instead")
    def ask_SamplePointsAuto(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_sample_points_auto()"""
        self.logger.warning(
            """Method 'ask_SamplePointsAuto()' is deprecated. 
            Please use 'get_sample_points_auto()' instead."""
        )
        return self.get_sample_points_auto(*args, **kwargs)

    @deprecated("Use 'get_sweep_speed' instead")
    def ask_SweepSpeed(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_sweep_speed()"""
        self.logger.warning(
            "Method 'ask_SweepSpeed()' is deprecated. Please use 'get_sweep_speed()' instead."
        )
        return self.get_sweep_speed(*args, **kwargs)

    @deprecated("Use 'get_trace_data_x' instead")
    def ask_TraceDataX(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_trace_data_x()"""
        self.logger.warning(
            "Method 'ask_TraceDataX()' is deprecated. Please use 'get_trace_data_x()' instead."
        )
        return self.get_trace_data_x(*args, **kwargs)

    @deprecated("Use 'get_trace_data_y' instead")
    def ask_TraceDataY(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_trace_data_y()"""
        self.logger.warning(
            "Method 'ask_TraceDataY()' is deprecated. Please use 'get_trace_data_y()' instead."
        )
        return self.get_trace_data_y(*args, **kwargs)

    @deprecated("Use 'get_sweep_mode' instead")
    def ask_SweepMode(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_sweep_mode()"""
        self.logger.warning(
            "Method 'ask_SweepMode()' is deprecated. Please use 'get_sweep_mode()' instead."
        )
        return self.get_sweep_mode(*args, **kwargs)

    @deprecated("Use 'get_trace_attribute' instead")
    def ask_TraceAttribute(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_trace_attribute()"""
        self.logger.warning(
            """Method 'ask_TraceAttribute()' is deprecated. 
            Please use 'get_trace_attribute()' instead."""
        )
        return self.get_trace_attribute(*args, **kwargs)

    @deprecated("Use 'set_display_y_unit' instead")
    def set_DisplayYUnit(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_display_y_unit()"""
        self.logger.warning(
            "Method 'set_DisplayYUnit()' is deprecated. Please use 'set_display_y_unit()' instead."
        )
        return self.set_display_y_unit(*args, **kwargs)

    @deprecated("Use 'set_bw_resolution' instead")
    def set_BWResolution(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_bw_resolution()"""
        self.logger.warning(
            "Method 'set_BWResolution()' is deprecated. Please use 'set_bw_resolution()' instead."
        )
        return self.set_bw_resolution(*args, **kwargs)

    @deprecated("Use 'set_sample_points' instead")
    def set_SamplePoints(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_sample_points()"""
        self.logger.warning(
            "Method 'set_SamplePoints()' is deprecated. Please use 'set_sample_points()' instead."
        )
        return self.set_sample_points(*args, **kwargs)
    ...
    @deprecated("Use 'set_trace_attribute' instead")
    def set_TraceAttribute(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_trace_attribute()"""
        self.logger.warning(
            """Method 'set_TraceAttribute()' is deprecated. 
            Please use 'set_trace_attribute()' instead."""
        )
        return self.set_trace_attribute(*args, **kwargs)
    ...
    @deprecated("Use 'get_segment_points' instead")
    def get_SegmentPoints(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_segment_points()"""
        self.logger.warning(
            "Method 'get_SegmentPoints()' is deprecated. Please use 'get_segment_points()' instead."
        )
        return self.get_segment_points(*args, **kwargs)

    @deprecated("Use 'set_sensitivity' instead")
    def set_Sensitivity(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_sensitivity()"""
        self.logger.warning(
            "Method 'set_Sensitivity()' is deprecated. Please use 'set_sensitivity()' instead."
        )
        return self.set_sensitivity(*args, **kwargs)

    @deprecated("Use 'set_span' instead")
    def set_Span(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_span()"""
        self.logger.warning("Method 'set_Span()' is deprecated. Please use 'set_span()' instead.")
        return self.set_span(*args, **kwargs)

    @deprecated("Use 'set_center_wavelenght' instead")
    def set_CenterWavelenght(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_center_wavelenght()"""
        self.logger.warning(
            """Method 'set_CenterWavelenght()' is deprecated. 
            Please use 'set_center_wavelenght()' instead."""
        )
        return self.set_center_wavelenght(*args, **kwargs)

    @deprecated("Use 'set_wavelength_start' instead")
    def set_WavelengthStart(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_wavelength_start()"""
        self.logger.warning(
            """Method 'set_WavelengthStart()' is deprecated. 
            Please use 'set_wavelength_start()' instead."""
        )
        return self.set_wavelength_start(*args, **kwargs)

    @deprecated("Use 'set_unit_x' instead")
    def set_UnitX(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_unit_x()"""
        self.logger.warning(
            "Method 'set_UnitX()' is deprecated. Please use 'set_unit_x()' instead."
        )
        return self.set_unit_x(*args, **kwargs)

    @deprecated("Use 'set_wavelength_stop' instead")
    def set_WavelengthStop(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_wavelength_stop()"""
        self.logger.warning(
            """Method 'set_WavelengthStop()' is deprecated. 
            Please use 'set_wavelength_stop()' instead."""
        )
        return self.set_wavelength_stop(*args, **kwargs)

    @deprecated("Use 'set_sample_points_auto' instead")
    def set_SamplePointsAuto(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_sample_points_auto()"""
        self.logger.warning(
            """Method 'set_SamplePointsAuto()' is deprecated. 
            Please use 'set_sample_points_auto()' instead."""
        )
        return self.set_sample_points_auto(*args, **kwargs)

    @deprecated("Use 'set_sweep_mode' instead")
    def set_SweepMode(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_sweep_mode()"""
        self.logger.warning(
            "Method 'set_SweepMode()' is deprecated. Please use 'set_sweep_mode()' instead."
        )
        return self.set_sweep_mode(*args, **kwargs)

    @deprecated("Use 'set_sweep_speed' instead")
    def set_SweepSpeed(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for set_sweep_speed()"""
        self.logger.warning(
            "Method 'set_SweepSpeed()' is deprecated. Please use 'set_sweep_speed()' instead."
        )
        return self.set_sweep_speed(*args, **kwargs)

    @deprecated("Use 'get_params_osa' instead")
    def get_ParamsOSA(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for get_params_osa()"""
        self.logger.warning(
            "Method 'get_ParamsOSA()' is deprecated. Please use 'get_params_osa()' instead."
        )
        return self.get_params_osa(*args, **kwargs)

    @deprecated("Use 'print_params_osa' instead")
    def print_ParamsOSA(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for print_params_osa()"""
        self.logger.warning(
            "Method 'print_ParamsOSA()' is deprecated. Please use 'print_params_osa()' instead."
        )
        return self.print_params_osa(*args, **kwargs)

    @deprecated("Use 'start_sweep' instead")
    def StartSweep(self, *args, **kwargs):  # noqa: N802
        """Deprecated alias for start_sweep()"""
        self.logger.warning(
            "Method 'StartSweep()' is deprecated. Please use 'start_sweep()' instead."
        )
        return self.start_sweep(*args, **kwargs)
